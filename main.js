...
if(userMoney >= totalMoney) {
   elResults.textContent = `${userName}, sayohatingiz maroqli o‘tsin`
} else {
    elResults.textContent = `${userName}, afsuski, siz sayohatga bora olmaysiz`
}

// let elForm = document.querySelector(".form");
// let elUserNumber1 = document.querySelector(".user-number1");
// let elUserNumber2 = document.querySelector(".user-number2");
// let elResult = document.querySelector(".results");

// elForm.addEventListener("submit", function(evt) {
//     evt.preventDefault();
//     let value1 = elUserNumber1.value;
//     // elResult.textContent = value1;

//     let numValue1 = elUserNumber1.value;
//     let numValue2 = elUserNumber2.value;

//     elResult.textContent = Number(numValue1.toLocaleString('en-US')) + Number(numValue2.toLocaleString('en-US'))
// });
